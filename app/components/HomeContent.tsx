            ...
            {isOpen && (
              ...
              >
                <div className="space-y-1">
                  ...
                  <a
                    href="https://github.com/ankitsingh1421/VisionTrack"
                    target="_blank"
...
　
      ...
      >
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          >
            <h2 className="text-4xl font-bold mb-4">About VisionTrack</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="space-y-4">
                ...
                VisionTrack is dedicated to revolutionizing developer education by providing clear, structured learning paths that guide you from beginner to expert. We believe in learning by doing, supported by a community of passionate developers.
                </p>
              </div>
　
　
      ...
      >
        <div className="max-w-7xl mx-auto">
          <motion.div variants={itemVariants} className="text-center mb-16">
            <h2 className="text-4xl font-bold mb-4">Why Choose VisionTrack</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <motion.div variants={itemVariants} className="p-8 bg-secondary rounded-xl border border-gray-medium">
              <h3 className="text-2xl font-bold mb-6">VisionTrack Learning</h3>
      ...
      >
        <div className="max-w-7xl mx-auto">
          <motion.div variants={itemVariants} className="text-center mb-16">
            ...
            <p className="text-accent max-w-2xl mx-auto">
              Hear from developers who transformed their careers with VisionTrack
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                quote: "VisionTrack has revolutionized my learning journey. The roadmaps are incredibly well-structured and the interactive features keep me engaged."
              },
              {
                name: "James Wilson",
